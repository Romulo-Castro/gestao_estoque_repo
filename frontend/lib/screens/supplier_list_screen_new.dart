...
class _SupplierListScreenState extends State<SupplierListScreen> {
  ...
  Widget _buildSupplierListTile(supplier) {
    return ListTile(
  ...
  Widget _buildSupplierGridCard(supplier) {
    return Card(
      child: InkWell(
        onTap: () => _navigateToSupplierDetail(supplier),
        child: Padding(
  ...
  Widget _buildSupplierCard(supplier) {
    return Card(
  ...
  Widget _buildSupplierTrailingAction(supplier) {
    return IconButton(
  ...
  void _navigateToSupplierDetail(supplier) {
    Navigator.of(context).push(
      MaterialPageRoute(
  ...
  Future<void> _confirmDeleteSupplier(supplier) async {
